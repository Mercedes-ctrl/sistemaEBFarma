...
function getHtml($id_venta)
{
  ...
  $plantilla = '
        ...
        <div id="company" class="clearfix">
            <div id="negocio">Farmacia EBFARMA</div>
            <div>Av.America Sur 275<br/> La libertad,Trujillo</div>
            <div>(51)921 341 498</div>
            <div><a href="mailto:company@example.com">ebfarmaci@gmail.com</a></div>
        </div>';
