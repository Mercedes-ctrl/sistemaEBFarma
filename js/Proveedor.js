$(document).ready(function() {
    ...
    function buscar_prov(consulta) {
        ...
        $.post('../controller/ProveedorController.php', {
            ...
            proveedores.forEach(proveedor => {
                template += `
                <div provId="${proveedor.id}" provNombre="${proveedor.nombre}" provRuc="${proveedor.ruc_proveedor}" provTelefono="${proveedor.telefono}" provCorreo="${proveedor.correo}" provDireccion="${proveedor.direccion}" provAvatar="${proveedor.avatar}" class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
                    ...
                    <div class="row">
                      <div class="col-7">
                        ...
                        <ul class="ml-4 mb-0 fa-ul text-muted">
                          <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> DNI: ${proveedor.ruc_proveedor}</li>
    ...
    $(document).on("click", ".editar", (e) => {
        ...
        //console.log(id);
        const nombre = $(elemento).attr('provNombre');
        const ruc_proveedor = $(elemento).attr('provRuc');
